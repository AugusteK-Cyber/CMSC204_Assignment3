...
public class SortedDoubleLinkedList_STUDENT_Test {
	...
	public Car a=new Car("Ferrari", "Roma", 2021);
	public Car b=new Car("Porsche", "Taycan", 2021);
	public Car c=new Car("Lamborghini", "Urus", 2021);
	public Car d=new Car("Tesla", "Model S", 2021);	
	public Car e=new Car("Audi", "A7", 2021);
	public Car f=new Car("Bentley", "Flying Spur", 2021);
	...
	public void testAddToEnd() {
		try {
			sortedLinkedString.addToEnd("Car");
	...
	public void testAddToFront() {
		try {
			sortedLinkedString.addToFront("Car");
			assertTrue("Did not throw an UnsupportedOperationException", false);
		}
		catch (UnsupportedOperationException e)
		{
	...
	public void testIteratorSuccessfulStringPrevious() {
		...
		sortedLinkedString.add("Collection");
		sortedLinkedString.add("Car");
		sortedLinkedString.add("Lion");
		...
		assertEquals("Lion", iterator.next());
		assertEquals(true, iterator.hasPrevious());
		assertEquals("Lion", iterator.previous());
		assertEquals("Collection", iterator.previous());
